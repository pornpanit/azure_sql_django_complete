...
mongo_username = urllib.parse.quote_plus('pornpanit')
mongo_password = urllib.parse.quote_plus('B_baitoey')
# MONGO_URI = 'mongodb://localhost:27017/'
MONGO_URI = f'mongodb+srv://{mongo_username}:{mongo_password}@pornpanit-mongodb.global.mongocluster.cosmos.azure.com/?tls=true&authMechanism=SCRAM-SHA-256&retrywrites=false&maxIdleTimeMS=120000'
